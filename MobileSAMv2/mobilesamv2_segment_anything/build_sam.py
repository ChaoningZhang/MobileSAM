...
def build_efficientvit_l0(checkpoint=None):
    ...
    if checkpoint is not None:
        ...
        mobile_samv2.load_state_dict(checkpoint)
    return mobile_samv2

def build_efficientvit_l1(checkpoint=None):
    backbone = EfficientViTLargeBackbone(
                width_list=[32, 64, 128, 256, 512],
...
def build_efficientvit_l2(checkpoint=None):
    backbone = EfficientViTLargeBackbone(
                width_list=[32, 64, 128, 256, 512],
...
sam_model_registry = {
    ...
    "efficientvit_l0": build_efficientvit_l0,
    "efficientvit_l1": build_efficientvit_l1,
